        ...
        <div className="space-y-12">
          {modules.map((module) => {
            ...
            return (
              ...
              >
                <div className="bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl p-6 text-white mb-6 shadow-lg">
                ...
                <div className="relative">
                  {/* Connecting line */}
                  <div className="absolute top-16 left-0 right-0 h-1 bg-gray-300 -z-10" />
